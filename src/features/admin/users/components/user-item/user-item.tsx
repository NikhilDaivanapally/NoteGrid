...
export function UserItem({ user, selfId }: { user: any; selfId: string }) {
          ...
          <AlertDialog>
            <DropdownMenu>
              ...
              <DropdownMenuContent>
                ...
                {user.banned ? (
                  <DropdownMenuItem onClick={() => handleUnbanUser(user._id)}>
                    Unban User
                  </DropdownMenuItem>
                ) : (
                  <DropdownMenuItem onClick={() => handleBanUser(user._id)}>
                    Ban User
                  </DropdownMenuItem>
                )}
                <DropdownMenuSeparator />
