...
import { ImageUploadNode as ImageUploadNodeComponent } from "@/components/editor/editor-node/image-upload-node/image-upload-node";
 ...
 * @see registry/editor-node/image-upload-node/image-upload-node
 */
